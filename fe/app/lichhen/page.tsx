  ...
  return (
    <div className="min-h-screen  py-10 px-4">
      <div className=" max-w-7xl min-h-screen mx-auto bg-white  ">
        <div className="  flex justify-between items-center  mb-6 px-10 py-6">
          <h1 className="text-3xl font-bold text-[#009990]">Hẹn lịch khám</h1>
          <button
            className="bg-[#009990] hover:bg-blue-700 transition text-white px-4 py-2 rounded-lg shadow font-semibold"
        ...
        {error && (
          <div className="mb-4 text-red-600 font-semibold p-8">{error}</div>
        )}
        {loading ? (
          ...
          <div className="space-y-6 p-8">
            {appointments.map((a) => (
              <div
                key={a.id}
                className={`flex flex-col md:flex-row md:items-center justify-between  bg-green-50 border border-green-200 rounded-lg p-4 shadow transition hover:shadow-lg ${a.status === "pending"
