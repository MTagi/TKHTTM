  ...
  return (
    <div className="min-h-screen  px-10 py-6" >
      <div className="max-w-8xl mx-auto  p-10">
        <h1 className="text-3xl font-bold text-[#009990] mb-8 flex items-center gap-2">
          Bảo hiểm của bệnh nhân
        </h1>
        {loading && (
          <div className="text-green-500 animate-pulse">Đang tải...</div>
        )}
        {message && (
        ...
        {!loading && patient && (
          <>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-[#009990] mb-2">
                Thông tin bệnh nhân
              </h2>
            ...
            <div className="h-px bg-[#009990] mb-8"></div>

            {/* Insurance Contracts */}
            <div className="mb-8">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-xl font-semibold text-[#009990]">
                  Hợp đồng bảo hiểm
                </h2>
                <button
                  className="bg-[#009990] hover:bg-green-600 text-white px-4 py-2 rounded shadow transition"
              ...
              {showNewContract && (
                <form
                  className=" rounded-lg p-4 mb-4 grid grid-cols-2 gap-4 animate-fade-in"
                ...
                >
                  ...
                  />
                  <button
                    className="col-span-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow transition"
                    type="submit"
                  >
                    Đăng ký
                  </button>
            ...
            <div>
              ...
              {showNewClaim && (
                <form
                  className="bg-green-50 rounded-lg p-4 mb-4 grid grid-cols-2 gap-4 animate-fade-in"
