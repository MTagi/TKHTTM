...
export default function DoctorAppointmentsPage() {
  ...
  return (
    <div className="min-h-screen  py-10 px-4">
      <div className="max-w-7xl mx-auto bg-white  p-8 animate-fade-in">
        <h1 className="text-3xl font-bold text-[#009990] mb-2 flex items-center gap-4">
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white rounded-lg shadow-sm">
              <thead>
                <tr>
                  <th className="px-4 py-2 text-left text-[#009990]">Stt</th>
                  <th className="px-4 py-2 text-left text-[#009990]">
                    Ngày hẹn
                  </th>
                  <th className="px-4 py-2 text-left text-[#009990]">Lý do</th>
                  <th className="px-4 py-2 text-left text-[#009990]">
                    Trạng thái
                  </th>
                  <th className="px-4 py-2 text-left text-[#009990]">
