  ...
  return (
    <div className="min-h-screen py-10 px-4">
      <div className="max-w-6xl mx-auto  p-8">
        <h1 className="text-3xl font-bold text-[#009990] mb-6 text-center">
        ...
        <form className="space-y-6" onSubmit={handleSubmit} autoComplete="off">
          ...
          <button
            type="submit"
            className={`w-full py-2 rounded-lg bg-[#009990] text-white font-semibold text-lg shadow hover:bg-blue-700 transition ${loading ? "opacity-60 cursor-not-allowed" : ""
              }`}
            disabled={loading}
          >
      ...
      <div className="max-w-7xl mx-auto mt-12">
        <h2 className="text-2xl font-bold text-[#009990] mb-4 text-center">
          Danh sách yêu cầu xét nghiệm
        </h2>
        <div className="overflow-x-auto rounded-lg shadow">
          <table className="min-w-full bg-white">
            <thead>
              <tr className=" text-[#009990]">
                  ...
                  <React.Fragment key={req.id}>
                    <tr className="hover:bg-blue-50 transition">
                      ...
                      <td className="py-2 px-4 align-top">
                        {patient
                          ? `#${patient.id} - ${users.find((u) => u.id === patient.user_id)
                            ?.username || "Không rõ"
                          }`
                          : `#${req.patient_id}`}
                      </td>
                      ...
                      <td className="py-2 px-4 align-top">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-bold ${req.status === "pending"
