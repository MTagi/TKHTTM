        ...
        {loading ? (
          ...
          <>
            ...
            <form
              ...
              className=" rounded-lg p-6 mb-8 shadow transition hover:shadow-lg"
            >
              <h2 className="text-xl font-semibold mb-4 text-[#009990]">
                Tạo chẩn đoán mới
              </h2>
              ...
              <div className="mt-6 flex justify-end">
                <button
                  type="submit"
                  disabled={creating}
                  className="bg-[#009990] hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded shadow transition disabled:opacity-60"
                >
                                  ...
                                  >
                                    ...
                                    <div className="flex gap-2">
                                      <button
                                        ...
                                        className="bg-[#009990] hover:bg-blue-700 text-white px-3 py-1 rounded text-sm"
                                      >
                                        {isEditing
                                          ? "Cập nhật"
                                          : "Tạo đơn thuốc"}
