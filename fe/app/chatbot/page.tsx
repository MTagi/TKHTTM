...
const BOT_AVATAR = "https://cdn-icons-png.flaticon.com/128/1068/1068549.png";
const USER_AVATAR = "https://cdn-icons-png.flaticon.com/128/2118/2118520.png";
...
export default function ChatbotPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  p-6">
      <div className="min-w-[90%] min-h-screen bg-white  shadow-2xl flex flex-col overflow-hidden">

        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 bg-gray-50">
          <h3 className="text-[#009990] font-bold text-3xl align-center py-3"> Healthcare Chatbot!</h3>
          {messages.map((msg, idx) => (
            ...
            >
              ...
              <div
                className={`px-4 py-2 rounded-2xl shadow transition-all duration-200 ${msg.sender === "user"
        ...
        <div className="px-4 py-3 bg-white border-t border-gray-200">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <button
              className="bg-gradient-to-r from-blue-500 to-green-500 text-white px-5 py-2 rounded-full font-semibold shadow hover:scale-105 transition disabled:opacity-50"
